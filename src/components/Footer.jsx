...
import linkedin from "../images/linkedinFoot.svg";
      ...
      <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="flex justify-center gap-2 pt-20 pb-20">
          <a
            ...
            target="_blank"
          >
            <img src={youtube} alt="instagram" width={35} height={35} />
          </a>
          <a
            className="footer-icons csicon"
            ...
            target="_blank"
          >
            <img src={telegram} alt="twitter" width={35} height={35} />
          </a>
          <a
            className="footer-icons csicon"
          ...
          <a
            ...
            target="_blank"
          >
            <img src={linkedin} alt="instagram" width={35} height={35} />
          </a>
          <a className="footer-icons csicon" href="tel:+998901122757">
            <img src={phone} alt="phone" width={35} height={35} />
          </a>
        </div>
